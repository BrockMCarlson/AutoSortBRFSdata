...
ops.Nfilt               = 32*3*nprobes;  % number of clusters to use (2-4 times more than Nchan, should be a multiple of 32)     		
ops.nNeighPC            = 12; % visualization only (Phy): number of channnels to mask the PCs, leave empty to skip (12)		
ops.nNeigh              = 16; % visualization only (Phy): number of neighboring templates to retain projections of (16)		
end

% options for channel whitening		
ops.whitening           = 'full';% atm, noSpikes causes an error for me, may need to play with STD below% type of whitening (default 'full', for 'noSpikes' set options for spike detection below)		
...
ops.initialize      = 'no';    %'fromData' or 'no'	% Dec 21, fromData not working for 160211_I_dotmapping001	
ops.spkTh           = 2.5;    % spike threshold in standard deviations (4)		
